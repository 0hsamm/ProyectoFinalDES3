...
public class ParticipanteConversacion {
	...
	public ParticipanteConversacion(Conversacion conversacion, Usuario usuario, LocalDateTime fechaIngresoChat,
	...
	@Override
	public int hashCode() {
		return Objects.hash(conversacion, fechaIngresoChat, fechaUltimoLeido, id, usuario);
	}
	...
	public String toString() {
		return "ParticipanteConversacion [id=" + id + ", conversacion=" + conversacion + ", usuario=" + usuario
				+ ", fechaIngresoChat=" + fechaIngresoChat + ", fechaUltimoLeido=" + fechaUltimoLeido + "]";
	}
