...
public class ArchivoAdjunto {
	...
	public ArchivoAdjunto(Mensaje mensaje, String rutaAlmacenamiento, String nombreOriginalArchivo,
			String formatoArchivo, long tamanoArchivo, String vi) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(formatoArchivo, id, mensaje, nombreOriginalArchivo, rutaAlmacenamiento, tamanoArchivo, vi);
	}
	...
	public String toString() {
		return "ArchivoAdjunto [id=" + id + ", mensaje=" + mensaje + ", rutaAlmacenamiento=" + rutaAlmacenamiento
				...
				+ ", tamanoArchivo=" + tamanoArchivo + ", vi=" + vi + "]";
	}
