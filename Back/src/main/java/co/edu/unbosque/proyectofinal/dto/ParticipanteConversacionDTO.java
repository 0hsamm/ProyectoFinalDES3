...
public class ParticipanteConversacionDTO {
	...
	public ParticipanteConversacionDTO(Long id, Long conversacionId, Long usuarioId, RolParticipante rol,
	...
	@Override
	public int hashCode() {
		return Objects.hash(conversacionId, fechaIngresoChat, fechaUltimoLeido, id, rol, usuarioId);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conversacionId, other.conversacionId)
				...
				&& rol == other.rol && Objects.equals(usuarioId, other.usuarioId);
	}
	...
	public String toString() {
		return "ParticipanteConversacionDTO [id=" + id + ", conversacionId=" + conversacionId + ", usuarioId="
				+ usuarioId + ", rol=" + rol + ", fechaIngresoChat=" + fechaIngresoChat + ", fechaUltimoLeido="
				+ fechaUltimoLeido + "]";
	}
