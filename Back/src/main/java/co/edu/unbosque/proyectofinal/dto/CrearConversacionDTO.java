...
public class CrearConversacionDTO {
	...
	public CrearConversacionDTO(TipoConversacion tipoConversacion, List<Long> usuariosId, String creador) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(creador, tipoConversacion, usuariosId);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(creador, other.creador) && tipoConversacion == other.tipoConversacion
				&& Objects.equals(usuariosId, other.usuariosId);
	}
