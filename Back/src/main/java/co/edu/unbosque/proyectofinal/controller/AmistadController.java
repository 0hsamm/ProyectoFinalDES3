...
public class AmistadController {
    ...
    obtenerSolicitudesRecibidas(
        ...
        return new ResponseEntity<>(
                solicitudAmistadService
                        .obtenerSolicitudesRecibidas(correo),
                HttpStatus.OK);
    }
    ...
    obtenerSolicitudesEnviadas(
        ...
        return new ResponseEntity<>(
                solicitudAmistadService
                        .obtenerSolicitudesEnviadas(correo),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> cancelarSolicitud(
        ...
        int estado =
                solicitudAmistadService.cancelarSolicitud(
                        correo,
                        id);
        ...
        case 3:
            return new ResponseEntity<>(
                    "No puedes cancelar esa solicitud",
    ...
    public ResponseEntity<List<AmistadDTO>> obtenerAmigos(
        ...
        return new ResponseEntity<>(
                solicitudAmistadService.obtenerAmigos(correo),
                HttpStatus.OK);
    }
